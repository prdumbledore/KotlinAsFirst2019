...
class Tests {
    ...
    fun lineByPoint() {
        ...
        assertApproxEquals(Line(Point(0.979397236382435, -2.220446049250313e-16), 0.0), lineByPoints(Point(0.979397236382435, 5e-324), Point(-632.0, 2.220446049250313e-16)))
